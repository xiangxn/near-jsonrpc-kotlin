...
class StateChangeWithCauseViewOneOf5ChangeTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of StateChangeWithCauseViewOneOf5Change
        //val modelInstance = StateChangeWithCauseViewOneOf5Change()
