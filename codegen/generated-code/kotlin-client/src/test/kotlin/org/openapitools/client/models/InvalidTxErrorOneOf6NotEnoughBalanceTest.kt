...
class InvalidTxErrorOneOf6NotEnoughBalanceTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of InvalidTxErrorOneOf6NotEnoughBalance
        //val modelInstance = InvalidTxErrorOneOf6NotEnoughBalance()
