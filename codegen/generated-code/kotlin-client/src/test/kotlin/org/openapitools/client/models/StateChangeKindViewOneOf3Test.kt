...
class StateChangeKindViewOneOf3Test : ShouldSpec() {
    init {
        // uncomment below to create an instance of StateChangeKindViewOneOf3
        //val modelInstance = StateChangeKindViewOneOf3()
