...
class StateChangeKindViewOneOfTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of StateChangeKindViewOneOf
        //val modelInstance = StateChangeKindViewOneOf()
