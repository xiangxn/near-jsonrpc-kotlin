...
class StateChangeKindViewOneOf2Test : ShouldSpec() {
    init {
        // uncomment below to create an instance of StateChangeKindViewOneOf2
        //val modelInstance = StateChangeKindViewOneOf2()
