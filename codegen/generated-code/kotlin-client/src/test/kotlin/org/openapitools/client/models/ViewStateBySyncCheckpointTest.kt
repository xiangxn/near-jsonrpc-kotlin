...
class ViewStateBySyncCheckpointTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ViewStateBySyncCheckpoint
        //val modelInstance = ViewStateBySyncCheckpoint()
