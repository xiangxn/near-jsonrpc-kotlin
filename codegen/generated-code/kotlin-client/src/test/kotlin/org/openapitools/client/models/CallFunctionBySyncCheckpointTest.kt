...
class CallFunctionBySyncCheckpointTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CallFunctionBySyncCheckpoint
        //val modelInstance = CallFunctionBySyncCheckpoint()
