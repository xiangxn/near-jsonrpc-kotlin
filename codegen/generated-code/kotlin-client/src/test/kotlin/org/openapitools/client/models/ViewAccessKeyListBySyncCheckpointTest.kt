...
class ViewAccessKeyListBySyncCheckpointTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ViewAccessKeyListBySyncCheckpoint
        //val modelInstance = ViewAccessKeyListBySyncCheckpoint()
