...
class ValidatorStakeViewTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ValidatorStakeView
        //val modelInstance = ValidatorStakeView()

        // to test the property `validatorStakeStructVersion`
        should("test validatorStakeStructVersion") {
            // uncomment below to test the property
            //modelInstance.validatorStakeStructVersion shouldBe ("TODO")
        }
