...
class StateChangeWithCauseViewOneOf9ChangeTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of StateChangeWithCauseViewOneOf9Change
        //val modelInstance = StateChangeWithCauseViewOneOf9Change()
