...
class ViewAccessKeyBySyncCheckpointTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ViewAccessKeyBySyncCheckpoint
        //val modelInstance = ViewAccessKeyBySyncCheckpoint()
