...
class ActionErrorKindOneOf11InsufficientStakeTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ActionErrorKindOneOf11InsufficientStake
        //val modelInstance = ActionErrorKindOneOf11InsufficientStake()
        ...
        // to test the property `minimumStake`
        should("test minimumStake") {
            // uncomment below to test the property
            //modelInstance.minimumStake shouldBe ("TODO")
        }
