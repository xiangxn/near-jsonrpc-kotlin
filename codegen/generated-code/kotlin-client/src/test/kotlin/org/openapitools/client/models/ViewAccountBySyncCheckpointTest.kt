...
class ViewAccountBySyncCheckpointTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ViewAccountBySyncCheckpoint
        //val modelInstance = ViewAccountBySyncCheckpoint()
