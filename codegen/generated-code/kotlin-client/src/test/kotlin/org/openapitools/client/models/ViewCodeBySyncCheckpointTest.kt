...
class ViewCodeBySyncCheckpointTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ViewCodeBySyncCheckpoint
        //val modelInstance = ViewCodeBySyncCheckpoint()
