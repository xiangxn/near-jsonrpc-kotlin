...
class ActionErrorKindOneOfAccountAlreadyExistsTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ActionErrorKindOneOfAccountAlreadyExists
        //val modelInstance = ActionErrorKindOneOfAccountAlreadyExists()
