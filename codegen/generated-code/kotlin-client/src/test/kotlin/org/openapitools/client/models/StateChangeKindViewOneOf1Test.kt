...
class StateChangeKindViewOneOf1Test : ShouldSpec() {
    init {
        // uncomment below to create an instance of StateChangeKindViewOneOf1
        //val modelInstance = StateChangeKindViewOneOf1()
