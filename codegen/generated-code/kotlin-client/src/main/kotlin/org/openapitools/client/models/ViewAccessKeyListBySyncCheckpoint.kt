...
data class ViewAccessKeyListBySyncCheckpoint (
    ...
    val requestType: ViewAccessKeyListBySyncCheckpoint.RequestType
     ...
     * 
     *
     * Values: view_access_key_list
     */
    @JsonClass(generateAdapter = false)
    enum class RequestType(val value: kotlin.String) {
        @Json(name = "view_access_key_list") view_access_key_list("view_access_key_list");
    }
